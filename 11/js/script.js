...
/***/ "./source/js/modules/animated-prizes-svg.js":
/*!**************************************************!*\
  !*** ./source/js/modules/animated-prizes-svg.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AnimatedPrizesSvg; });
class AnimatedPrizesSvg {
...
class FullPageScroll {
  constructor() {
    ...
    this.pageSwitchHandler = new _page_switch_handler__WEBPACK_IMPORTED_MODULE_1__["default"]();
  }
...
/* harmony import */ var _animated_prizes_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animated-prizes-svg */ "./source/js/modules/animated-prizes-svg.js");
...
class PageSwitchHandler {
  constructor() {
    const introTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 500, `accent-typography--active`, `transform`);
    const introDate = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 500, `accent-typography--active`, `transform`, 500);
    const sliderTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.slider__item-title`, 500, `accent-typography--active`, `transform`);
    const prizesTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.prizes__title`, 500, `accent-typography--active`, `transform`);
    const rulesTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.rules__title`, 500, `accent-typography--active`, `transform`);
    const gameTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"](`.game__title`, 500, `accent-typography--active`, `transform`);
    const prizesSvg = new _animated_prizes_svg__WEBPACK_IMPORTED_MODULE_1__["default"](`.js-prizes-icon`);
    const gameTimer = new _game_timer__WEBPACK_IMPORTED_MODULE_2__["default"](`.game__counter`, 5);
...
/***/ "./source/js/modules/result-switch-handler.js":
/*!****************************************************!*\
  !*** ./source/js/modules/result-switch-handler.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ResultSwitchHandler; });
/* harmony import */ var _svg_path_animator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./svg-path-animator */ "./source/js/modules/svg-path-animator.js");


class ResultSwitchHandler {
  constructor() {
    const resultSvgTrip = new _svg_path_animator__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-result-svg-trip`, `result_svg_trip`, 0.5);
    const resultSvgPrize = new _svg_path_animator__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-result-svg-prize`, `result_svg_prize`, 0.5);
    const resultSvgNegative = new _svg_path_animator__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-result-svg-negative`, `result_svg_negative`, 0.5, 0.02, `transform`, 0.6, 0.05);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _result_switch_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./result-switch-handler */ "./source/js/modules/result-switch-handler.js");


/* harmony default export */ __webpack_exports__["default"] = (() => {
  const resultSwitchHandler = new _result_switch_handler__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/***/ "./source/js/modules/svg-path-animator.js":
/*!************************************************!*\
  !*** ./source/js/modules/svg-path-animator.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SvgPathAnimator; });
