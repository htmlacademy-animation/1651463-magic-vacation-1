...
class PageSwitchHandler {
  constructor() {
    const introTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 500, `accent-typography--active`, `transform`);
    const introDate = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 500, `accent-typography--active`, `transform`, 500);
    const sliderTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.slider__item-title`, 500, `accent-typography--active`, `transform`);
    const prizesTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.prizes__title`, 500, `accent-typography--active`, `transform`);
    const rulesTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.rules__title`, 500, `accent-typography--active`, `transform`);
    const gameTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.game__title`, 500, `accent-typography--active`, `transform`);
